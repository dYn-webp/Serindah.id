...
export default async function AdminDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      {/* AREA KONTEN: min-w-0 sangat penting agar tabel tidak merusak layout */}
      <main className="flex-1 w-full min-w-0 p-5 pt-20 md:p-8 md:ml-64">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          <div className="p-5 md:p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            ...
            <a href="/admin/orders" className="text-xs md:text-sm font-bold text-blue-600 hover:text-blue-700 bg-blue-50 px-4 py-2 rounded-lg transition-colors">Lihat Semua</a>
          </div>
